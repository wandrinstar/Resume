...
var HTMLprojectTechnologiesStart = '<div class="technologies"></div>'
var HTMLprojectTechnology = '<li class="technology">%data%</li>';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#">%data%</a>';
var HTMLschoolDegree = '<br><p>%data%</p>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    locWithActivities.push(["live", bio.contacts.location]);
    ...
    for (var school in education.schools) {
      ...
      locWithActivities.push(["studied", education.schools[school].location]);
    }
    ...
    for (var job in work.jobs) {
      ...
      locWithActivities.push(["worked", work.jobs[job].location]);
    }
  ...
  function getActivity(address) {
    var activity = "was";
    for (pair in locWithActivities) {
      if (address.slice(0,3) == locWithActivities[pair][1].slice(0,3)) { // Slicing cause Google's address won't match ours exactly
        activity = locWithActivities[pair][0];
      }
    }
    return activity;
  }
  ...
  */
  function createMapMarker(placeData) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      ...
      var activity = getActivity(address);
      infoWindow.setContent('<div class="infoWindow">I ' + activity + " in " + address + '</div>');
...
function inName() {
    ...
    var firstName = nameArray.slice(0, 1);
    var middleName = "";
    if (nameArray.length > 2) {
        middleName = nameArray.slice(1,-1);
    }
